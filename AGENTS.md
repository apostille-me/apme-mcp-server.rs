# AGENTS.md — apostille-me/apme-mcp-server.rs
...
- GitHub org: [`apostille-me`](https://github.com/apostille-me)
- Repository: [`apostille-me/apme-mcp-server.rs`](https://github.com/apostille-me/apme-mcp-server.rs)
- Local checkout: `~/codes/apostille-me/apme-mcp-server.rs`
- Linear project: https://linear.app/denman/project/githubcomapostille-me-c884fbdbd637
- GitHub org project: https://github.com/orgs/apostille-me/projects/1
- Sibling test org: `github.com/apostille-me-test` (external/e2e coverage and extra GHA minutes)
- Slack workspace: oresoftware-workspace.slack.com
- Kind: product MCP server for this GitHub org
- Package / service name: `apme-mcp-server`
